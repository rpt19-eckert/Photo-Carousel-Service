...
import Empty from '../client/src/components/Empty.jsx';
import HardcodePhotos from '../client/src/components/HardcodePhotos.jsx';
import './style.css';
 ...
 formatIncomingData (input) {
  ...
  componentDidMount() {
    ...
    let data = {listingId: id};
      $.ajax({
        method: 'GET',
        url: 'http://177.71.192.202/listing-info',
        data,
        dataType: 'text',
        success: (result) => {
